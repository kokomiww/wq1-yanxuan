  ...
  <div class="goods-detail">
    ...
    <van-action-bar>
      ...
      <van-action-bar-icon
        icon="cart-o"
        text="购物车"
        :badge="$store.getters['cart/cartListTotal']>0?$store.getters['cart/cartListTotal']:''"
...
export default {
  ...
  setup() {
    ...
    const getDetail = async () => {
      let { basicInfo, content, pics, properties } = await getGoodsDetail(id.value)
      goods.pics = pics
    ...
    return { skuChange, active, ...toRefs(goods), showSkuPanel, id, show }
  }
}
</script>
