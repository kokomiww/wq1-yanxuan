<template>
  <div class="pay-ment">
    ...
    <div class="amount-wrapper">
      ...
      <div class="order-info">
        <div class="order-price-wrapper">
          ...
          <span class="order-price">￥{{$store.getters['orderData']['amount']}}</span>
        </div>
        <div class="order-number">订单号：{{$store.getters['orderData']['orderNumber']}}</div>
      </div>
    </div>
    <!-- 收货地址区域 -->
    <default-address
    ...
    <div
      class="payment-btn"
      @click="payment"
    >微信支付￥{{$store.getters['orderData']['amount']}}</div>
  </div>
</template>
